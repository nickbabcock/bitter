...
df <- mutate(df,
             ...
             throughput = value * iteration_count * 1000 * 10^9 / sample_time_nanos
)
...
ggplot(reldf, aes(fn, as.factor(value))) +
  ...
  ggtitle("Comparison of Mean Throughput (GB/s) of Rust bit readers", subtitle = "at varying bit-sized reads") +
